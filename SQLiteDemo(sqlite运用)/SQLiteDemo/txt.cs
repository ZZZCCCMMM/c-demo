...
namespace SQLiteDemo
{
    public partial class txt : Form
    {
        ...
        private const string DBAddress = "txt.db";
        ...
        {
            logla.Text = "请填入要添加人员的ID，姓名，号码和地址。";
            try
            {
                Dictionary<string, object> dic = new Dictionary<string, object>();
                dic.Add("ID", textBoxid.Text);
                dic.Add("Name", textBoxname.Text.ToString());
                dic.Add("phone", textBoxphone.Text);
                dic.Add("adress", textBoxadress.Text);
                int result = SQLiteHelpers.InsertData("table1", dic);
                logla.Text = "已经添加了" + result + "个联系人";
